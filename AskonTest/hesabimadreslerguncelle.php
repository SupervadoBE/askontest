				...
				<table width="500" align="center" border="0" cellpadding="0" cellspacing="0">
					...
					<tr height="30">
						<td valign="top" align="left">
							<input type="text" name="IsimSoyisim" class="InputAlanlari" value="<?php echo $KayitBilgisi['AdiSoyadi']; ?>" >
						</td>
					</tr>
					...
					<tr height="30">
						<td valign="top" align="left">
							<input type="text" name="Adres" class="InputAlanlari" value="<?php echo $KayitBilgisi['Adres']; ?>" >
						</td>
					</tr>
					...
					<tr height="30">
						<td valign="top" align="left">
							<input type="text" name="Ilce" class="InputAlanlari" value="<?php echo $KayitBilgisi['Ilce']; ?>" >
						</td>
					</tr>
					...
					<tr height="30">
						<td valign="top" align="left">
							<input type="text" name="Sehir" class="InputAlanlari" value="<?php echo $KayitBilgisi['Sehir']; ?>" >
						</td>
					</tr>
					...
					<tr height="30">
						<td valign="top" align="left">
							<input type="tel" name="TelefonNumarasi" class="InputAlanlari" value="<?php echo $KayitBilgisi['TelefonNumarasi']; ?>" >
						</td>
					</tr>

					<tr height="40">
						<td align="center">
							<input type="submit" class="YesilButton" value="Adresi Güncelle">
						</td>
					</tr>
