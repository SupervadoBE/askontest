	...
	if($KullaniciSayisi>0){
		...
		if($KullaniciKaydi['Durumu'] == 1){
			...
			try
			{
				...
				$MailGonder->Body    = "Merhaba Sayın	" . $KullaniciKaydi['IsimSoyisim'] ."<br /><br />Sitemize yapmış oldugunuz üyelik kaydını tamalamak için lütfen <a herf='" . $SiteLinki . "/aktivasyon.php?AktivasyonKodu=" . $KullaniciKaydi['AktivasyonKodu'] . "&EmailAdresi=" . $GelenEmailAdresi . "'>BURAYA TIKLAYINIZ</a> <br /><br /> Saygılarımızla İyi Çalışmalar...<br />" . $SiteAdi;
